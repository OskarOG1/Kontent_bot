...
| 9 | PLAN_EDITY_9_FABRYKA | restart bez strat, biblioteka wzorów z wyborem, warianty, partie, `/ponow`; nakładka z kryciem (flaga, 9.5, zaraz po części 8); słowa w rytmie i napis pionowy jak w `0923` (9.6 do 9.8, po części 6) | 9.5 scalone w PR #14 i wdrożone; 9.6 do 9.9 na gałęzi `rytm`, odbiór OK 2026-09-26, bez PR; 9.1 do 9.4 do zrobienia | klip flagi jako nakładka, akceptacja czcionki pisanej | Sonnet |
