...
1. Zrobione: części 1, 2, 7, 3, 4, 8 i 5.
   ...
   - Część 5 scalona i wdrożona. Najpierw zadanie 5.6 (niebo bez przebarwienia), potem zadanie 9.5 (nakładka z kryciem dla flagi), każde osobnym PR-em, potem część 6.
